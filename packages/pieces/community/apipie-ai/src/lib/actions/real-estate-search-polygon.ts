...
export const realEstateSearchPolygon = createAction({
  ...
  description:
    'Search for real estate properties by polygon area using Real Estate API through RapidAPI.',
  props: {
    polygon: Property.LongText({
      displayName: 'Location',
      description:
        'Polygon coordinates string for search area (e.g. through google maps).',
      required: true,
    }),
